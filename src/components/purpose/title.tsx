        ...
        <AnimatedDiv animationType="fade-up" delay={ANIMATION_DELAY_0}>
          <div className="text-center mb-16">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground leading-relaxed max-w-4xl mx-auto">
              Na{" "}
              <span className="font-semibold text-primary italic">EcoPlaceTour</span>
              {""}, acreditamos que crescer sozinho é pouco, mas crescer junto é
              transformador. Nosso propósito vai além de organizar visitas
              técnicas ou viagens: queremos gerar impacto positivo em cada
              pessoa, em cada comunidade e no planeta que compartilhamos.
            </p>
          </div>
        </AnimatedDiv>
      </div>

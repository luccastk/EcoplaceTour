        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-6">
              Somos uma empresa que nasceu da paixão por unir educação, turismo
              e sustentabilidade em um só movimento. É por isso que trabalhamos
              em dois pilares complementares:
            </p>
            <div className="space-y-4">
              <div className="flex items-start space-x-4">
                ...
                <p className="text-muted-foreground">
                  ...
                  aprendizado de quem participa, nas comunidades que nos recebem
                  e no planeta que compartilhamos.
                </p>
              </div>
            </div>
          </div>

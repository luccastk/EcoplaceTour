        ...
        <div className="grid md:grid-cols-2 gap-8">
          <AnimatedDiv animationType="fade-right" delay={ANIMATION_DELAY_200}>
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-border/50">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Visitas técnicas e experiências educativas que aproximam teoria
                e prática, ampliando horizontes de estudantes e profissionais.
              </p>
              <Link
                to="/edu"
          ...
          <AnimatedDiv animationType="fade-left" delay={ANIMATION_DELAY_400}>
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-border/50">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Pacotes de viagem e experiências culturais que encantam,
                inspiram e criam memórias inesquecíveis.
              </p>
              <Link
                to="/travel"
